...
export function SessionNavBar({ pathname = "" }: SessionNavBarProps) {
                ...
                <ScrollArea className="h-16 grow p-2">
                  <div className={cn("flex w-full flex-col gap-1")}>
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5 transition hover:bg-muted hover:text-primary",
                        isActive("reports") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        ...
                        isActive("chat") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("deals") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("accounts") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("competitors") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("library") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("feedback") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <a
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        isActive("review") && "bg-muted text-blue-600",
                      )}
                    >
                      <FileClock className="h-4 w-4" />{" "}
                      <motion.li variants={variants}>
